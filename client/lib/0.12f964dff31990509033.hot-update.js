	...
	Canvas.prototype = {
	    ...
	    preloadTexture: function preloadTexture() {
	        ...
	        for (var i = 0; i < cfg.foodPaletteSize; i++) {
	            var canFood = this.createFoodTexture(i, 5);
	    ...
	    createFoodTexture: function createFoodTexture(i, mass) {
	        ...
	        var edgecolor1 = "rgba(" + b.r + "," + b.g + "," + b.b + ",0.5)"; // + (0.9 + mass * 0.03) + ")";
	        var edgecolor2 = "rgba(" + b.r + "," + b.g + "," + b.b + ",0.0)";
	        gradblur.addColorStop(0, edgecolor1);
	        gradblur.addColorStop(0.8, edgecolor1);
	        gradblur.addColorStop(0.99, edgecolor2);
	        ctx.fillStyle = gradblur;
	        ctx.arc(b.x, b.y, b.rad, 0, Math.PI * 2, false);
	        ctx.fill();
	        ctx.fillStyle = "rgba(" + b.r + "," + b.g + "," + b.b + ",0.6)";
	        ctx.beginPath();
	        ctx.arc(b.x, b.y, b.rad - 6 - mass / 2, 0, Math.PI * 2, false);
	        // ctx.fill();
