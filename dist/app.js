...
var express = require('express'),
    ...
    multer = require('multer'); //upload pic server-side


var cfgPassport = require('./app/controllers/passport.js'),
    routes = require('./routes.js');
var isProduction = process.env.NODE_ENV === 'production';

(0, _database2.default)(mongoose);
...
app.use(favicon(__dirname + '/client/img/museum.png'));
app.use(logger('dev'));
